...
export default function ContactSection({ 
  ...
  contactImage = "https://placehold.co/800x600/2d5016/ffffff?text=Contact+MKM+Trees"
}: ContactSectionProps) {
  return (
            ...
            <div className="bg-gray-50 p-8 shadow-sm border-l-4 border-gray-200 hover:border-yellow-400 transition-colors duration-200">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#F3ED17' }}>
                  ...
                  <div>
                    ...
                    <Link 
                      ...
                      className="text-lg font-semibold text-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 px-1 py-0.5 rounded relative group"
                    >
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">Service Area</p>
