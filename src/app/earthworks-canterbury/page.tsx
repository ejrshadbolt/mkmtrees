...
export default function EarthworksPage() {
  ...
  return (
    <ParentServicePage
      ...
      problemTitle="The Problem with Challenging Rural Land"
      problemDescription="Many rural or semi-rural properties around Canterbury struggle with land that's overrun, uneven, or impossible to work with. Over time, weeds, scrub, and buried stumps take over. Soil gets hard-packed. Tracks wash out or become unusable. You're left with land that's more stress than value. DIY gear usually isn't up to the task. Many general earthmoving contractors aren't used to station-style jobs where access is rough and timing matters."
      solutionTitle="Why MKM's Earthworks Approach Works Better"
      solutionDescription="We specialise in land that's rural, rugged, or high-demand. Our team regularly handles station work, land clearing, and heavy-duty tilling for properties across Selwyn, Mid-Canterbury, and the Christchurch surrounds. We know how to work efficiently on uneven ground, remote sites, and where paddock access is limited. Our operators are experienced, our gear is specialised, and we leave every site tidied and ready for what's next."
