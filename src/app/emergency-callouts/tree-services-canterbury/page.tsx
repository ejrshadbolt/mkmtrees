...
export default function EmergencyTreeServicesPage() {
  ...
  return (
    <ChildServicePage
      ...
      problemTitle="The Problem with Storm & Tree Emergencies"
      problemDescription="Storms in Canterbury can knock down large trees in seconds — crushing sheds, blocking driveways, or tearing through fences. Sometimes it's not the tree that falls, but one that leans dangerously or shows cracks after high winds. These aren't jobs to wait on, and they're not safe to DIY. Untrained operators often make the damage worse. Cutting pressure-loaded limbs without the right method can send branches flying or trigger further damage."
      solutionTitle="How MKM Handles Tree Emergencies Properly"
      solutionDescription="Our team of qualified arborists and emergency responders have the training and tools to work fast — and safely. We assess the situation on arrival, secure the site, and remove or stabilise dangerous trees using elevated saws, winches, and heavy-duty gear. We don't just hack the tree down. We work with care to avoid further damage, preserve what's still safe, and restore access as quickly as possible."
